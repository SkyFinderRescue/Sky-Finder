...
train=load('multi_train',ROOT/'aerialtrack_alt'/'train_multiclass.py');prov=load('prov',ROOT/'aerialtrack_compute'/'research'/'reuse_first'/'validate_training_provenance.py');ev=load('ev',ROOT/'aerialtrack_compute'/'research'/'reuse_first'/'evaluate_predictions.py')
def sha(p):
 h=hashlib.sha256()
 with p.open('rb') as f:
